/*
  # Create Phone System Tables
  
  1. New Tables:
    - sip_settings: Store SIP configuration per user
    - call_history: Complete call logs with all details
    - call_recordings: Recording files metadata
    - permissions: User permissions system (phone.use)
  
  2. Security: Enable RLS on all tables
  3. Policies: User can only access their own data
*/
...
-- User Permissions table (for future phone.use permission)
