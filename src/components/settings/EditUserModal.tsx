...
const EditUserModal: React.FC<EditUserModalProps> = ({
  ...
  const { register, handleSubmit, formState: { errors }, reset, watch } = useForm<EditUserFormData>({
    defaultValues: {
      nome: user.nome,
      email: user.email,
  ...
  const onSubmit = async (data: EditUserFormData) => {
    try {
      ...
      if (changePassword && data.senha !== data.confirmPassword) {
        ...
        <div className="border-b border-gray-200 p-6">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <h2 className="text-xl font-bold text-[#404040]">Editar Usuário</h2>
            </div>
            <button
              onClick={handleClose}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 rounded-lg p-4">
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-semibold text-[#404040]">Alterar Senha</h3>
